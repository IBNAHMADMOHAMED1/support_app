   ...
   <div class="flex bg-white shadow-lg rounded-lg mx-52 md:mx-auto  mt-5 max-w-md md:max-w-2xl  "><!--horizantil margin is just for display-->
      <div class="flex items-start px-4 py-4 pt-0 ">
         ...
         <form class="flex items-start space-x-6 pl-6 py-2 rounded-lg bg-white ">
              <div class="shrink-0">
                <img class="md:h-12 md:w-12 lg:h-12 lg:w-12 h-10 w-10 object-cover rounded-full" src="https://images.unsplash.com/photo-1542156822-6924d1a71ace?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=500&q=60" alt="Current profile photo" />
              </div> 
              <div class='flex flex-col bg-gray-100 w-9/12 rounded-lg px-3 pb-3 '>
               <div class=''>
                 
                 <div class="title-font text-sm md:text-base flex items-center justify-between  lg:text-1xl font-bold pt-3 text-gray-900"> <p>Knausgaard typewriter</p>
